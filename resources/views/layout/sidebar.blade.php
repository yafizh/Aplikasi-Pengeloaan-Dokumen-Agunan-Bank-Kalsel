      ...
      <div class="nav-link">
        <div class="user-wrapper">
          ...
          <div class="text-wrapper">
            <p class="profile-name">Ahmad Rifa'i</p>
      ...
      <div class="collapse {{ show_class(['user-pages/*']) }}" id="user-pages">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item {{ active_class(['user-pages/login']) }}">
            <a class="nav-link text-wrap" href="{{ url('/user-pages/login') }}">Laporan Daftar Agunan Berdasarkan Jenis Agunan</a>
          </li>
          <li class="nav-item {{ active_class(['user-pages/register']) }}">
            <a class="nav-link text-wrap" href="{{ url('/user-pages/register') }}">Laporan Status Verifikasi Dokumen Agunan</a>
          </li>
          <li class="nav-item {{ active_class(['user-pages/lock-screen']) }}">
            <a class="nav-link text-wrap" href="{{ url('/user-pages/lock-screen') }}">Laporan Masa Berlaku Dokumen Agunan</a>
          </li>
          <li class="nav-item {{ active_class(['user-pages/lock-screen']) }}">
            <a class="nav-link text-wrap" href="{{ url('/user-pages/lock-screen') }}">Laporan Peminjaman dan Pengembalian Dokumen Agunan</a>
          </li>
          <li class="nav-item {{ active_class(['user-pages/lock-screen']) }}">
            <a class="nav-link text-wrap" href="{{ url('/user-pages/lock-screen') }}">Lapora Letak Agunan</a>
          </li>
          <li class="nav-item {{ active_class(['user-pages/lock-screen']) }}">
            <a class="nav-link text-wrap" href="{{ url('/user-pages/lock-screen') }}">Laporan Ketersediaan Ruang Penyimpanan Dokumen Agunan</a>
          </li>
        </ul>
      </div>
    </li>
