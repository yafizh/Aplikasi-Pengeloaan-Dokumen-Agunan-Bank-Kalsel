        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('dokumen-agunan.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex" style="gap: 1rem;">
                                        <div>
                                            <input type="radio" id="KreditMultiguna" value="Kredit Multiguna"
                                                name="jenis_kredit">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="tanggal_akad" name="tanggal_akad"
                                        required>
                                </div>
                                <div class="mb-3">
